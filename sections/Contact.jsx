...
export default function Contact(){
  ...
  // In validateForm(), add email validation:
const validateForm = () => {
  ...
  return(
    <section id="contact" className="w-full py-24 bg-black overflow-hidden text-white py-20 px-6 md:px-20 flex flex-col
...
<motion.img src={Astra} alt="Contact"
  ...
  <div className="flex flex-col">
    ...
    value={formData.idea}
    onChange={handleChange}
    className={`p-3 rounded-md bg-white/10 border ${errors.idea ? "border-red-500":"border-gray-500"} text-white focus:outline-none focus:border-blue-500`}></textarea>
